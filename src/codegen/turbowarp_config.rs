...
impl Display for TurbowarpConfig {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        write!(f, "You can move, resize, and minimize this comment, but don't ")?;
        write!(f, "edit it by hand. This comment can be deleted to remove the ")?;
...
impl From<&Config> for TurbowarpConfig {
    fn from(config: &Config) -> Self {
        ...
        Self {
            ...
            no_miscellaneous_limits: config.no_miscellaneous_limits.unwrap_or(default.no_miscellaneous_limits),
            no_sprite_fencing: config.no_sprite_fencing.unwrap_or(default.no_sprite_fencing),
            frame_interpolation: config.frame_interpolation.unwrap_or(default.frame_interpolation),
